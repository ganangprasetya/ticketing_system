                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea name="pic_complaint" class="col-8 form-control{{ ($errors->has('pic_complaint')) ? ' is-invalid':'' }}" id="pic_complaint" placeholder="PIC Complaint">{{ old('pic_complaint') }}</textarea>
                                    <div class="invalid-feedback">
                                ...
                                <td>
                                    <div class="form-group">
                                        <div class="input-group datepicker">
                                            <input type="text" name="date_complaint" class="col-7 form-control datetimepicker bg-white{{ ($errors->has('date_complaint')) ? ' is-invalid':'' }}" value="{{ old('date_complaint') }}" required data-input/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea name="note" class="col-8 form-control{{ ($errors->has('note')) ? ' is-invalid':'' }}" id="note" placeholder="Note Complaint">{{ old('note') }}</textarea>
                                </td>
                            </tr>
